...
export class PostScheduledTransactionDto {
  @ApiPropertyOptional({ description: 'Transaction date (defaults to next due date)' })
  @IsOptional()
  @IsDateString()
  ...
  @ApiPropertyOptional({ description: 'Override category ID for this posting only' })
  @IsOptional()
  @IsUUID()
  categoryId?: string | null;

  @ApiPropertyOptional({ description: 'Override description for this posting only' })
  @IsOptional()
  @IsString()
  ...
  @ApiPropertyOptional({ description: 'Override splits for this posting only', type: [InlineSplitDto] })
  @IsOptional()
  @IsArray()
