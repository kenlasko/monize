...
describe('AuthService', () => {
  ...
  beforeEach(async () => {
    ...
    const module: TestingModule = await Test.createTestingModule({
      providers: [
        ...
        { provide: getRepositoryToken(UserPreference), useValue: preferencesRepository },
        { provide: getRepositoryToken(TrustedDevice), useValue: trustedDevicesRepository },
        ...
        { provide: JwtService, useValue: jwtService },
        {
          ...
          useValue: {
            get: jest.fn().mockImplementation((key: string) => {
              if (key === 'JWT_SECRET') return 'test-jwt-secret-minimum-32-chars-long';
              return undefined;
            }),
          },
        },
  ...
  describe('register', () => {
    it('creates a new user and returns token pair', async () => {
      ...
      usersRepository.create.mockImplementation((data) => ({ ...data, id: 'new-user' }));
      usersRepository.save.mockImplementation((user) => ({ ...user, id: 'new-user' }));
    ...
    it('makes first user an admin', async () => {
      ...
      usersRepository.create.mockImplementation((data) => ({ ...data, id: 'first-user' }));
  ...
  describe('login', () => {
    ...
    it('throws for wrong password', async () => {
      ...
      usersRepository.findOne.mockResolvedValue({ ...mockUser, passwordHash: hashedPassword });
    ...
    it('returns 2FA required when enabled', async () => {
      ...
      preferencesRepository.findOne.mockResolvedValue({ twoFactorEnabled: true });
