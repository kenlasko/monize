...
export class CurrenciesController {
  ...
  @ApiResponse({ status: 200, description: 'List of active currencies', type: [Currency] })
  ...
  @ApiResponse({ status: 200, description: 'Latest exchange rates per currency pair', type: [ExchangeRate] })
  ...
  @ApiResponse({ status: 200, description: 'Exchange rates within the date range', type: [ExchangeRate] })
  getRateHistory(
