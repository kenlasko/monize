...
const categories: CategoryDef[] = [
  ...
  { parent: 'Clothing', children: ['Accessories', 'Clothes', 'Coats', 'Shoes'] },
  { parent: 'Computer', children: ['Hardware', 'Software', 'Web Hosting'] },
  { parent: 'Education', children: ['Books', 'Fees', 'Tuition'] },
  { parent: 'Food', children: ['Alcohol', 'Cannabis', 'Dining Out', 'Groceries'] },
  { parent: 'Furnishings', children: ['Accessories', 'Appliances', 'Basement', 'Bathroom', 'Bedroom', 'Dining Room', 'Dishes', 'Kitchen', 'Living Room', 'Office', 'Outdoor', 'Plants'] },
  { parent: 'Gifts', children: ['Anniversary', 'Birthday', 'Cards', 'Christmas', 'Flowers', "Mother's Day", 'RESP Contribution', 'Valentines', 'Wedding'] },
  { parent: 'Healthcare', children: ['Counselling', 'Dental', 'Eyecare', 'Fertility', 'Fitness', 'Hospital', 'Massage', 'Medication', 'Physician', 'Physiotherapy', 'Prescriptions', 'Supplies'] },
  { parent: 'Housing', children: ['Fees', 'Garden Supplies', 'Home Improvement', 'Maintenance', 'Mortgage Interest', 'Mortgage Principal', 'Rent', 'Supplies', 'Tools'] },
  { parent: 'Insurance', children: ['Automobile', 'Disability', 'Health', "Homeowner's/Renter's", 'Life', 'Travel'] },
  { parent: 'Interest Expense', children: [] },
  { parent: 'Leisure', children: ['Books & Magazines', 'Camera/Film', 'Camping', 'CD', 'Cover Charge', 'Cultural Events', 'DVD', 'Electronics', 'Entertaining', 'Entertainment', 'Fees', 'Gambling', 'LPs', 'Movies', 'Newspaper', 'Sporting Events', 'Sporting Goods', 'Sports', 'Toys & Games', 'Transit', 'VHS', 'Video Rentals'] },
  { parent: 'Loan', children: ['Loan Interest', 'Loan Principal', 'Mortgage Interest'] },
  { parent: 'Miscellaneous', children: ['Postage', 'Postcards', 'Stamps', 'Tools', 'Transit'] },
  { parent: 'Personal Care', children: ['Dry Cleaning', 'Haircut', 'Laundry', 'Pedicure', 'Toiletries'] },
  { parent: 'Pet Care', children: ['Food', 'Supplies', 'Veterinarian'] },
  { parent: 'Taxes', children: ['CPP/QPP Contributions', 'EI Premiums', 'Federal Income', 'Goods & Services', 'Other', 'Property', 'Real Estate', 'State/Provincial', 'Union Dues'] },
  { parent: 'Vacation', children: ['Airfare', 'Car Rental', 'Entertainment', 'Gasoline', 'Lodging', 'Miscellaneous', 'Parking', 'Transit'] },
];
...
async function addDefaultCategories() {
  ...
  for (const user of users) {
    ...
    console.log(`  Added ${parentCount} parent categories and ${childCount} child categories`);
  }
