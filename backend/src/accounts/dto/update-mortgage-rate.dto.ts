...
export class UpdateMortgageRateDto {
  @ApiProperty({
    example: 5.25,
    description: 'New annual interest rate as percentage (e.g., 5.25 for 5.25%)',
  })
  ...
  @ApiPropertyOptional({
    example: 2500.0,
    description: 'Optional new payment amount. If omitted, payment will be recalculated based on current balance and remaining amortization.',
  })
  @IsOptional()
