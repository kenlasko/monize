...
const InvestmentTransactionRow = memo(function InvestmentTransactionRow({
  ...
  return (
    <tr
      ...
      className={`group hover:bg-gray-50 dark:hover:bg-gray-700/30 ${density !== 'normal' && index % 2 === 1 ? 'bg-gray-50 dark:bg-gray-800' : ''} ${onEdit ? 'cursor-pointer' : ''}`}
    >
      ...
      {hasActions && (
        <td className={`${cellPadding} whitespace-nowrap text-right text-sm space-x-3 hidden min-[480px]:table-cell sticky right-0 ${density !== 'normal' && index % 2 === 1 ? 'bg-gray-50 dark:bg-gray-800' : 'bg-white dark:bg-gray-800'} group-hover:bg-gray-50 dark:group-hover:bg-gray-700/30`}>
          {onEdit && (
            <button
