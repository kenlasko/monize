...
const mockPayees = [
  {
    ...
    defaultCategory: { id: 'cat-1', name: 'Groceries', userId: 'user-1', parentId: null, parent: null, children: [], description: null, icon: null, color: null, isIncome: false, isSystem: false, createdAt: '2024-01-01T00:00:00Z' },
    notes: null,
    createdAt: '2024-01-01T00:00:00Z',
  },
  {
...
function createExistingTransaction(overrides = {}) {
  return {
    ...
    payee: null,
    categoryId: 'cat-1',
    category: { id: 'cat-1', name: 'Groceries', userId: 'user-1', parentId: null, parent: null, children: [], description: null, icon: null, color: null, isIncome: false, isSystem: false, createdAt: '2024-01-01T00:00:00Z' },
    amount: -50.0,
    currencyCode: 'CAD',
    exchangeRate: 1,
