              ...
              <div className="bg-gray-50 rounded-lg p-4">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                  <button
                    ...
                    className="flex flex-col items-center justify-center p-6 bg-white border-2 border-gray-200 rounded-lg hover:border-blue-500 hover:shadow-md transition-all"
                  >
                    <svg
                    ...
                    <span className="text-xs text-gray-500 mt-1">Manage income & expenses</span>
                  </button>
                  ...
                  >
                    ...
                    <span className="text-xs text-gray-500 mt-1">View all accounts</span>
                  </button>
                  ...
                  >
                    ...
                    <span className="text-sm font-medium text-gray-900">Budgets</span>
                    <span className="text-xs text-gray-500 mt-1">Track spending goals</span>
                  </button>
                  ...
                  >
                    ...
                    <span className="text-sm font-medium text-gray-900">Payees</span>
                    <span className="text-xs text-gray-500 mt-1">Manage payees</span>
                  </button>
                  ...
                  >
                    ...
                    <span className="text-xs text-gray-500 mt-1">Organize transactions</span>
                  </button>
                  ...
                  >
                    ...
                    <span className="text-xs text-gray-500 mt-1">Financial insights</span>
                  </button>
                </div>
              </div>
            </div>
