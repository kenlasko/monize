...
function makeTransaction(overrides: Partial<Transaction> = {}): Transaction {
  ...
  return {
    ...
    payeeId: 'pay-1',
    payeeName,
    payee: { id: 'pay-1', userId: 'test-user-id', name: payeeName, defaultCategoryId: null, defaultCategory: null, notes: null, createdAt: '2025-01-01T00:00:00Z' },
    categoryId: 'cat-1',
    category: { id: 'cat-1', userId: 'test-user-id', name: 'Groceries', description: null, icon: null, color: null, isIncome: false, isSystem: false, parentId: null, parent: null, children: [], createdAt: '2025-01-01T00:00:00Z' },
    amount: -50,
    currencyCode: 'USD',
    exchangeRate: 1,
    description: null,
